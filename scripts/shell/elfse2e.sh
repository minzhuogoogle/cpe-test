...
case "$testname" in
    ...
    *elfs-ha-*-node* ) echo "prepare ha test";hatest=1;iotest=1;mfio=0;nodefailure=1;emsname="ha-$disktype-elfs";enodename="ha-$disktype-elfs-elfs"; testvmname="ha-elfs-$disktype";skipprovision=0;;
    *elfs-ha-*-disk* ) echo "prepare ha test";hatest=1;iotest=1;mfio=0;diskfailure=1;emsname="ha-$disktype-elfs";enodename="ha-$disktype-elfs-elfs"; testvmname="ha-elfs-$disktype";skipprovision=0;;
