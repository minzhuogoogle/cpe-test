...
for this sample.
teemo.mqtt.py --project_id iot-certification  --registry_id IoT-Chromebox   --private_key_file  /home/mzhuo/rsa_private.pem --device_id=teemp-1 --algorithm=RS256
"""
...
def main():
 ...
 #   for i in range(1, args.num_messages + 1):
    ...
    while True: 
        ...
        payload = 'registry:{} device:{} payload:{}-{}-{}-{}-{}-{}'.format(
                args.registry_id, args.device_id, i, timestamp, 'teemo', pinfo[0], pinfo[1], pinfo[2])
